...
function convertSessionInterface(session: EntityItem<typeof sessionEntity>): DatabaseSession {
    return {
...
function convertUserInterface(user: EntityItem<typeof userEntity>): DatabaseUser {
    return {
        id: user.userId,
        attributes: user
    }
